            ...
            <v-sheet width="450px">
                    ...
                    <v-simple-table dense>
                        ...
                        <tr>
                            ...
                            <td>20'000</td>
                            <td>50'000</td>
                            <td><v-btn :color=this.colors[0] x-small block></v-btn></td>
                        </tr>
                        <tr>
                            <td>Secondaire</td>
                            <td>14'000</td>
                            <td>25'000</td>
                            <td>12'000</td>
                            <td><v-btn :color=this.colors[1] x-small block></v-btn></td>
                        </tr>
                        <tr>
                            <td>Tertiaire</td>
                            <td>12'000</td>
                            <td>8'000</td>
                            <td>11'000</td>
                            <td><v-btn :color=this.colors[2] x-small block></v-btn></td>
                        </tr>
...
<script>
    ...
    export default {
        ...
        components: {ScTitrePartie, ScTitreSection, ScChart},
        props: {
